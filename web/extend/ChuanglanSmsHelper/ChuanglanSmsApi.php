...
class ChuanglanSmsApi {
	...
	const API_BALANCE_QUERY_URL='http://smssh1.253.com/msg/send/json';//创蓝短信余额查询接口URL
	
	const API_ACCOUNT= 'N7121237'; // 创蓝API账号
	
	const API_PASSWORD= 'lxjFIADELz2045';// 创蓝API密码
