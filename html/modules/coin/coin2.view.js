define(function (require, exports, modules) {
    ...
    var template = require('text!./coin2.tpl.html'),
        util = require('util');
        ...
        show_morning: function () {
            ...
            window.jsonpGet('Trade/show_morning', {
                ...
                if (json.code == 1) {
                    ...
                    $('#new_price_cny').html('≈' + (parseFloat(data.price) * parseFloat(data.usdt_price)).toFixed(2) + ' CNY');
                    morning_buy_max = window.avg((parseFloat(data.main_coin_balance) / (1 + parseFloat(data.fee)) / parseFloat(data.price)), 2);
                    ...
                    morning_sell_max = window.avg(parseFloat(data.main_coin_balance) / parseFloat(data.fee) / parseFloat(data.price), 2);
        ...
        show_afternoon: function () {
            ...
            window.jsonpGet('Trade/show_afternoon', {
                ...
                if (json.code == 1) {
                    ...
                    $('#new_price').html(parseFloat(data.price) + ' USDT');
                    $('#new_price_cny').html('≈' + (parseFloat(data.price_cny)).toFixed(4) + ' CNY');
                    ...
                    var change = parseFloat(data.change_rate).toFixed(2);
